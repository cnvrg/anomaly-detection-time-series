import pandas as pd
import unittest
from iforest import NoCSVError, ContaminationValueError
from iforest import (
    validate_arguments,
    get_contamination,
...
class TestValidateArguments(TestIForest):
...
class TestGetContamination(TestIForest):
...
class TestSplitFeaturesLabels(TestIForest):
    def test_return_type(self):
...
class TestMapLabels(TestIForest):
    def test_return_type(self):
