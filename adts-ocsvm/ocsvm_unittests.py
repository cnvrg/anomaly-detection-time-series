import pandas as pd
import unittest
from ocsvm import NoCSVError, ContaminationValueError
from ocsvm import (
    validate_arguments,
    get_contamination,
...
class TestValidateArguments(TestOCSVM):
...
class TestGetContamination(TestOCSVM):
...
class TestSplitFeaturesLabels(TestOCSVM):
    def test_return_type(self):
